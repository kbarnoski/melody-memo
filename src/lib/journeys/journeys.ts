  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      expansion: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 2 — portal entry + MAZE. She steps through a
          // portal into the earth and travels through a LABYRINTH of
          // branching root tunnels. User directive 2026-04-20: "make it
          // clear she enters a portal to underground and goes through a
          // maze and finds that water."
          // Beats 1-2: portal. Beats 3-6: MAZE. Beat 7: approaches light.
          "photorealistic cinematic wide shot of a natural organic portal opening downward into the earth at the far end of a grand medieval stone castle chamber, the portal is made of intertwining ancient tree roots woven into a downward archway with pure white flowers (all-white centers, NO yellow) blooming along the root edges, a dark pulling void visible through the portal drawing inward, wisps of darkness reaching out of the portal. " + GHOST_ANGEL_WINGLESS + " small hovering toward the portal with her arms at her sides, back to the camera, long white spiral hair cascading to the floor and trailing in the air with white particles. mysterious ethereal portal-entry, no text no watermarks",
          "photorealistic cinematic wide shot framing the threshold of the organic root portal from inside the earth looking back up toward the grand castle chamber far above (now a small square of light at the top of the frame), the portal interior made of ancient tree roots with white flowers, darkness pulling her downward into a maze. " + GHOST_ANGEL_WINGLESS + " small passing THROUGH the portal threshold with her back to the camera and her arms spread outward like a falling leaf, long white spiral hair flowing upward and around her in fibonacci curls, white particles. mysterious ethereal passing-through-the-portal, no text no watermarks",
          // Maze beat 1 — fork in the path.
          "photorealistic cinematic wide shot of a LABYRINTHINE natural deep-earth cavern network, the passage ahead FORKING into THREE branching tunnels of massive gnarled tree roots leading off into different darknesses, pale bioluminescent teal lichen glowing on the walls, a maze of root corridors receding in every direction. " + GHOST_ANGEL_WINGLESS + " small hovering at the fork with her back to the camera, arms raised slightly as if deciding which way to go, long white spiral hair cascading and trailing, white particles. mysterious ethereal underground labyrinth, no text no watermarks",
          // Maze beat 2 — twisting spiral passage that doubles back.
          "photorealistic cinematic wide rear tracking shot through a TWISTING SPIRALING natural deep-earth tunnel of gnarled tree roots that curves and doubles back on itself like a labyrinth, the passage winding downward and sideways through a natural maze, pale bioluminescent teal glow. " + GHOST_ANGEL_WINGLESS + " small and distant moving through the twisting tunnel with her back to the camera and her arms trailing behind her, long white spiral hair flowing in the curving currents of air, white particles. mysterious ethereal underground labyrinth, no text no watermarks",
          // Maze beat 3 — crossroads seen from above.
          "photorealistic cinematic extreme overhead top-down shot looking straight down at a natural deep-earth LABYRINTH of branching root tunnels — a crossroads junction where FOUR passages meet in a chamber of massive intertwining tree roots, pure white flowers blooming at the intersections, pale bioluminescent teal glow. " + GHOST_ANGEL_WINGLESS + " a tiny figure far below at the crossroads seen from above, arms outstretched to her sides, long white spiral hair fanning around her in a fibonacci spiral on the earth floor, white particles. mysterious ethereal labyrinth aerial view, no text no watermarks",
          // Maze beat 4 — towering maze walls, narrow corridor.
          "photorealistic cinematic worm's-eye low-angle shot looking up at TOWERING LABYRINTH WALLS of massive gnarled tree roots rising on both sides of a narrow natural passage deep in the earth, the maze walls reaching impossibly high toward a vaulted ceiling lost in darkness, pale bioluminescent teal lichen glowing, organic root stalactites dripping from above. " + GHOST_ANGEL_WINGLESS + " small hovering forward between the towering maze walls, her back to camera, arms crossed over her chest peacefully, long white spiral hair trailing upward with white particles. mysterious ethereal labyrinth interior, no text no watermarks",
          "photorealistic cinematic forward-looking wide shot from behind deep into the final stretch of the deep-earth maze, the walls of gnarled tree roots narrowing toward a distant point of pale teal-amber light glowing far ahead at the maze's exit. " + GHOST_ANGEL_WINGLESS + " small in the middle of the passage with her back to camera and her arms now reaching forward toward the distant light (which is the water ahead), long white spiral hair streaming with white particles. mysterious ethereal maze-ends-at-the-water, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 5 — REVISED 2026-04-20 per user directive:
          // "show flowers bloom as she merges with it." Previously bloom
          // happened first, then merge; now the two progress TOGETHER.
          // Phase runtime extended 0.72→0.88 so this 8-beat sequence has
          // more time to breathe. Merge cascades from contact point —
          // arm dissolves → torso dissolves → hair becomes branches —
          // with bloom radiating outward in lockstep.
          ...
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet in infinite cosmos with EVERY BRANCH 100 PERCENT covered in pure white flowers (not a single bare twig remaining), warm golden-sunset light streaming through every branch in radiant shafts, universe sky of stars nebulae galaxies. " + GHOST_ANGEL + " (white, peak adult form) has FULLY merged and dissolved INTO the tree — only faint traces of her form visible in the wood grain of the trunk, her long white spiral hair now flows as spiraling branches cascading through the bloomed crown, her translucent wispy wings now are branch-shapes of light woven through the canopy. she and the tree are ONE. mysterious ethereal transcendent union complete, no text no watermarks",
        ],
        aiPromptModifiers: {
