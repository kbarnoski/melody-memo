...
export const JOURNEYS: Journey[] = [
  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      // ANCIENT CHAMBER: moonlit stone room, cosmic window, first hint of roots in the floor.
      // Lower shader opacity so shaders breathe through the dark areas.
      threshold: {
        start: 0.0,
        end: 0.14,
        shaderOpacity: 0.75,
        aiPrompt: "photorealistic ancient stone chamber bathed in pale silvery moonlight — the chamber vast and mostly empty with generous deep black shadows filling two-thirds of the frame, tall arched window on the far right opening onto infinite deep cosmic void with scattered distant stars, a single narrow luminous diagonal shaft of moonlight cutting across worn stone floors illuminating spectral particles like tiny stars — the light occupying only a thin band leaving vast dark space around it, ancient tree roots threading through cracks in the worn stone floor barely visible in the dim light — dark gnarled tendrils pushing through the seams as if something vast lives beneath, in the lower-left third a small translucent dark feminine figure draped in flowing ethereal robes facing away toward the cosmic window — seen only from behind at a distance, not filling the frame but intimate within the enormous dark space, the figure shifts subtly between diverse feminine forms as if a spirit changing shape — transparent overlapping layers showing the gesture across time, beside her a translucent duplicate slowly pulling away — the soul separating, both figures with impossibly abundant long dark hair in divine fibonacci spiraling curls drifting upward weightlessly — the curls dissolving into luminous particle threads at the tips spiraling into the dark upper void like living constellations, the upper two-thirds of the frame deep black void with only scattered particle threads and spiraling hair filaments visible — open space where darkness breathes, spectral particles sparse and floating in the dark air like distant stars, the figures small and ethereal against the massive dark chamber — emerging from swirling particles not solid bodies, in the window glass a ghostly reflection that doesn't match anyone, the mood deeply haunting and spacious — vast dark emptiness with small luminous moments, no faces visible — only silhouettes from behind, no halos, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      expansion: {
        ...
        shaderOpacity: 0.65,
        aiPrompt: "photorealistic view looking into a mysterious ancient stone opening in the earth anchored in the lower-right third of the frame — rough dark stone framed by massive ancient tree roots descending into the depths, the roots thick and gnarled pulling the eye downward into the portal, pale bioluminescent lichen growing along the root bark, the portal itself not filling the frame but a focal element within vast surrounding darkness, the upper-left two-thirds deep black void with only sparse floating spectral particles and the faintest wisps of luminous spores drifting across — open dark space where shader light bleeds through, at the portal threshold a small dark feminine angelic form draped in ethereal flowing fabric seen from behind entering ahead of you following the roots down — no face visible, her impossibly abundant grey wispy hair in divine Leonardo fibonacci spiraling curls streaming behind her trailing luminous particles dissolving into spiral threads at the tips, some hair strands extending far upward and leftward into the dark void above as delicate isolated threads of light against blackness, beside her a translucent spirit duplicate already deeper — the soul leading inward along the roots, the stone surface photorealistic with erosion and moisture — roots threading through every crack and crevice, patches of cold bioluminescence on root and stone, the darkness within the portal magnetic and bottomless, scattered organic elements — a single pale root tendril crossing the dark void overhead, a floating spore cluster in the upper portion, a wisp of luminous fungal thread — isolated small elements creating depth in the negative space without filling it, the mood deeply haunting and spacious — vast darkness with an intimate portal moment, cool silver and organic earth tones, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // DEEP UNDERGROUND: following roots through stone tunnels, hair and roots intertwining.
      // The deepest darkest point — roots alive with bioluminescent veins.
      transcendence: {
        start: 0.35,
        end: 0.55,
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic underground tunnel system carved through ancient dark stone — massive ancient tree root systems threading through the stone walls and ceiling like veins of a living creature, the passage visible in the lower-right portion of the frame curving into depth, the upper-left half deep black void — an impossibly tall cavern ceiling lost in darkness where roots descend from above and scattered bioluminescent points float like underwater stars, the roots alive with faint bioluminescent veins pulsing cold blue-green light along their bark, the stone walls rough and wet catching faint light from the luminous roots, pale organic luminescence and spectral particles swirling through the tunnels like living currents, a tall statuesque dark feminine angelic form in the tunnel seen from behind draped in flowing ethereal fabric — her impossibly abundant grey wispy hair in divine Leonardo fibonacci spiraling curls trailing upward into the vast dark ceiling void intertwining with the descending roots until hair and root become indistinguishable, the hair becoming isolated luminous threads crossing the dark empty space overhead like a constellation map, beside her a translucent spirit duplicate separating and drifting ahead along the root path, distant hair-particle traces spiraling through the far darkness like echoes of her presence, the hair streams threading through the roots creating a spiraling luminous web of organic and ethereal, spectral particles sparse in the vast dark air, photorealistic wet dark granite with veins of pale mineral, the deepest darkest point of the journey — no sky no escape only roots and stone and her, in the far distance the faintest suggestion of warmer light, no faces visible, the mood haunting and subterranean with vast vertical dark space, deep indigo and spectral silver with amber bioluminescent accents, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic surreal impossible landscape — a single massive ancient gnarled tree rooted in a floating island of dark earth and rock suspended in vast open cosmic space, the frame dominated by deep cosmic void — generous dark emptiness filling two-thirds with scattered distant stars, the tree's enormous root system spiraling downward from the floating rock in divine fibonacci curves — the roots themselves impossibly long and sculptural twisting in mathematical spirals through open space trailing luminous particle threads at their tips like hair, the roots and the cosmos intertwined, woven through the branches a tall statuesque dark feminine angelic form draped in flowing ethereal fabric — seen only from behind turned away, no face visible, her impossibly abundant grey wispy hair in divine Leonardo fibonacci spiraling curls streaming along the trunk and through the spiraling roots — hair and roots becoming one continuous cascading fibonacci display of organic mathematical beauty dissolving into luminous particle threads connecting to distant stars, a translucent spirit duplicate slowly separating into the cosmos, the floating rock photorealistic with exposed strata and trailing earth crumbling at the edges, the mood transcendent and vast — the underground darkness left behind now replaced by overwhelming cosmic revelation, no halos, no detailed faces, photorealistic bark texture, deep earth tones and spectral silver-blue warming at the edges, NOT illustration style — photorealistic materials and lighting throughout, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPrompt: "photorealistic vast dark cosmic space warming from deep indigo-black at the lower edges to the subtlest amber glow in the upper-right — the massive ancient gnarled tree on its floating island of dark earth visible with roots descending below back into stone and darkness — the whole underground journey traceable in one frame, she is among the branches now woven through them ascending, a dark silhouetted feminine figure draped in ethereal flowing fabric seen from behind in the left third — not filling the frame but intimate within cosmic vastness, impossibly abundant grey wispy hair in divine da Vinci fibonacci spiraling curls interwoven with branches and threads of golden light streaming upward — the curls dissolving into luminous particle threads spiraling through the canopy, no halo — only the warmth of the light catching the dark silhouette, the body dissolving into warmth and trailing particles from the waist down, hair transitioning from cool silver at the lowest tendrils to warm gold at the highest, fine luminous particles and golden embers rising through the branches, the roots below descending back into the earth — dark gnarled forms threading into stone, generous dark void filling the lower half and right — the darkness of earlier phases finally breaking as warmth enters, NOT illustration — photorealistic lighting and materials, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPrompt: "photorealistic warm golden radiance flooding vast cosmic space from the upper-right — deep indigo-black receding to the far edges as amber-gold light fills the upper portion like sunrise through the cosmos itself, volumetric golden rays streaming diagonally, in the upper-right portion a tall statuesque luminous feminine angelic figure seen ONLY from behind — absolutely NO face visible not even in profile, only dark silhouette against golden light, the figure not filling the frame but anchored in the right third with generous dark void on the left, impossibly abundant grey wispy hair in divine Leonardo da Vinci fibonacci spiraling curls interlaced with threads of pure gold light — the hair overwhelmingly alive flowing in massive spiraling cascades trailing behind and downward filling the space with Alphonse Mucha-style Art Nouveau flowing organic curves, individual hair strands becoming luminous particle threads that spiral outward in fibonacci patterns dissolving into constellations at the tips, the figure more hair and light than body — from the waist down dissolving into thousands of warm golden particles descending gently, far below the faintest ghost of ancient roots descending into dark earth — the memory of the underground journey she emerged from, small isolated floating elements scattered in the dark void — a spiral of golden particles drifting alone, a wisp of luminous hair disconnected and floating like a jellyfish tendril, fragments of light, the smaller ghost figure far below in the lower-left still dark and translucent — grey wispy fibonacci spiral hair streaming upward connecting to the figure above, all figures emerging from particles and light not solid bodies — NEVER showing detailed facial features only silhouettes and dark profiles, the hair IS the subject — divine spiraling cascading luminous particle hair filling space with organic mathematical beauty, NOT illustration style — photorealistic volumetric golden light and real material textures, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
