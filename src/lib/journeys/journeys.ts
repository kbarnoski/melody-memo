  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      illumination: {
        ...
        shaderOpacity: 0.78,
        aiPrompt: "photorealistic surreal impossible landscape — emerging from dark underground stone into vast open cosmic space, a single massive ancient gnarled tree rooted in a floating island of dark earth in the upper-left third, its roots extending downward through open air into deep cosmic void below where they become luminous filaments connecting to distant star clusters, the tree's branches reaching upward into starfield above, the scale overwhelming after the claustrophobic tunnels, woven through the branches and roots a dark feminine angelic form draped in ethereal flowing fabric — turned away and partially hidden among the upper branches, no face visible, beside her a translucent spirit duplicate slowly separating and drifting outward into the cosmos — the soul departing, her grey wispy hair in divine Leonardo fibonacci spiraling curls streaming downward along the trunk and through every root becoming the luminous connections to the cosmos below, a second translucent dark feminine figure floats distant in the void — only trailing spiral hair and particles visible interweaving with the root-threads creating a shimmering network between earth and stars, a third barely-visible wisp of particles and hair far below, all figures ethereal — emerging from spectral particles not solid bodies, the mood haunting but opening — the underground darkness giving way to cosmic vastness, no halos, no detailed faces, fine particles dispersing from the hair intersections into the generous void, photorealistic bark texture on the tree, deep earth tones and spectral silver-blue, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
