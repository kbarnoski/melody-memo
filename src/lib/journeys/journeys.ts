  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      threshold: {
        ...
        shaderOpacity: 0.75,
        aiPrompt: "photorealistic ancient stone chamber bathed in pale silvery moonlight — the chamber vast and mostly empty with generous deep black shadows filling two-thirds of the frame, tall arched window on the far right opening onto infinite deep cosmic void with scattered distant stars, a single narrow luminous diagonal shaft of moonlight cutting across worn stone floors illuminating spectral particles like tiny stars — luminous wisps and spectral particle trails drifting through the dark air, ancient tree roots threading through cracks in the worn stone floor — dark gnarled tendrils pushing through the seams, in the lower-left third a dark feminine angelic being levitating just above the stone floor draped in an impossibly long flowing ethereal gown that pools and trails across the stone like liquid shadow — large semi-transparent wings folded behind her barely visible like veils of dark gossamer, seen ONLY from behind at a distance NEVER showing face or profile, her impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls winding outward in precise mathematical spirals — very very long and abundant curls with luminous particles perpetually spiraling around every strand like orbiting stars, the hair dissolving into luminous particle threads at the tips spiraling into the dark upper void, beside her a translucent duplicate slowly pulling away — the soul separating, luminous wisps trailing from the hem of the long gown, the upper two-thirds deep black void with scattered particle threads and spiraling hair filaments — open space where darkness breathes, in the window glass a ghostly reflection that doesn't match anyone, the mood deeply haunting and spacious, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // FOLLOWING ROOTS DOWN: massive ancient roots descend into a stone portal, she follows them in.
      // Composition: portal and figure occupy lower-right, vast dark void above.
      expansion: {
        start: 0.14,
        end: 0.35,
        shaderOpacity: 0.65,
        aiPrompt: "photorealistic view looking into a mysterious ancient stone opening in the earth anchored in the lower-right third of the frame — rough dark stone framed by massive ancient tree roots descending into the depths, the roots thick and gnarled pulling the eye downward into the portal, pale bioluminescent lichen growing along the root bark, the portal itself not filling the frame but a focal element within vast surrounding darkness, the upper-left two-thirds deep black void with sparse floating spectral particles and luminous wisps drifting across — open dark space where shader light bleeds through, at the portal threshold the same dark feminine angelic being draped in an impossibly long flowing ethereal gown trailing far behind her across the stone — the fabric dissolving into luminous wisps and spectral particles at the hem, large semi-transparent wings slightly unfurled behind her like veils of dark gossamer catching bioluminescent light, seen ONLY from behind entering ahead of you following the roots down — NEVER showing face or profile, her impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls streaming behind her — very very long winding mathematical spirals with luminous particles perpetually spiraling around every strand, some hair strands extending far upward into the dark void above as delicate threads of light, beside her a translucent spirit duplicate already deeper — the soul leading inward along the roots, the stone surface photorealistic with erosion and moisture — roots threading through every crack, patches of cold bioluminescence on root and stone, the darkness within the portal magnetic and bottomless, cool silver and organic earth tones, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // DEEP UNDERGROUND: vast cavern from above, hair and roots intertwining.
      // Diverse perspectives — looking down, looking up, wide cavern. Spiraling flowers bring life.
      transcendence: {
        start: 0.35,
        end: 0.55,
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic vast underground cavern seen from a high vantage looking downward — massive ancient tree root systems threading through the stone walls and across the cavern like veins of a living creature, the cavern impossibly deep and wide, scattered bioluminescent points floating like underwater stars, the roots alive with faint bioluminescent veins pulsing cold blue-green light, white luminous flowers spiraling along the roots and blooming from cracks in the stone — delicate white petals with fibonacci spiral arrangements building in density and surrounding the central figure, the same dark feminine angelic being levitating in the center of the cavern draped in an impossibly long flowing ethereal gown that cascades downward and spirals around her like a living thing — the fabric and white flowers and luminous particles all swirling and building around her form, large semi-transparent wings spread wide behind her like veils of dark gossamer, seen ONLY from above and behind — NEVER showing face or profile, her impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls radiating outward in all directions — very very long winding mathematical spirals intertwining with the roots until hair and root become indistinguishable, luminous particles perpetually spiraling around every strand, white flower petals caught in the spiral currents of her hair, spectral particle trails and luminous wisps swirling densely through the vast dark air around her, photorealistic wet dark granite with veins of pale mineral, in the far distance the faintest warm golden light visible through the roots, no faces visible, deep indigo and spectral silver with amber bioluminescent accents, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // THE GREAT TREE: massive tree on floating rock in cosmic void, fibonacci spiral roots
      // cascading into space, her hair and the roots one continuous cosmic display.
      illumination: {
        start: 0.55,
        end: 0.78,
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic surreal impossible landscape — a single massive ancient gnarled tree rooted in a floating island of dark earth and rock suspended in vast open cosmic space, the frame dominated by deep cosmic void — generous dark emptiness filling two-thirds with scattered distant stars and distant nebula warmth, the tree's enormous root system spiraling downward from the floating rock in divine fibonacci curves — the roots themselves impossibly long and sculptural twisting in mathematical spirals through open space trailing luminous particle threads and wisps at their tips, luminous flowers spiraling along some roots in fibonacci patterns — delicate blooms transitioning from cold silver to the faintest warm gold, woven through the branches a tall statuesque dark feminine angelic form levitating among the canopy draped in an impossibly long flowing ethereal gown trailing down through the branches like cascading liquid light — the fabric dissolving into luminous wisps and golden particles at the edges, large semi-transparent wings folded gracefully behind her like veils of dark gossamer catching golden light at the edges, seen ONLY from behind — NEVER showing face or profile, her impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls streaming along the trunk and through the spiraling roots — hair and roots becoming one continuous cascading fibonacci display dissolving into luminous particle threads connecting to distant stars, spectral wisps and particle trails swirling through the cosmic void, a translucent spirit duplicate slowly separating into the cosmos, the floating rock photorealistic with exposed strata and trailing earth, the warmth of golden amber light beginning to glow from the upper edges of the cosmos — the transition to golden light approaching, no halos, no detailed faces, photorealistic bark texture, deep earth tones warming to amber at the edges, NOT illustration style — photorealistic materials and lighting throughout, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // AMONG THE BRANCHES: she's woven through the great tree, ascending with warmth.
      // The whole underground journey visible below — roots descend back into the earth.
      // Hair transitioning cool→gold, spiraling through branches.
      return: {
        start: 0.78,
        end: 0.871,
        bloomIntensity: 0.35,
        ...
        aiPrompt: "photorealistic vast dark cosmic space warming from deep indigo-black at the lower edges to the subtlest amber glow in the upper-right — the massive ancient gnarled tree on its floating island of dark earth visible with roots descending below back into stone and darkness, she is among the branches now woven through them levitating and ascending, the same dark feminine angelic being draped in an impossibly long flowing ethereal gown that cascades downward through the branches like liquid golden light — the fabric dissolving into luminous wisps and warm particles at the trailing edges, large semi-transparent wings half-unfurled behind her catching warm amber light through the translucent membranes, seen ONLY from behind — NEVER showing face or profile — anchored in the left third not filling the frame but intimate within cosmic vastness, impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls interwoven with branches and threads of golden light streaming upward — the curls dissolving into luminous particle threads and wisps spiraling through the canopy, no halo — only the warmth of the light catching the dark silhouette, luminous wisps and golden particle trails swirling everywhere through the branches, hair transitioning from cool silver at the lowest tendrils to warm gold at the highest, fine luminous particles and golden embers rising through the branches, generous dark void filling the lower half and right — the darkness of earlier phases finally breaking as warmth enters, NOT illustration — photorealistic lighting and materials, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // GOLDEN TRANSCENDENCE: she dissolves into golden particles and hair spirals.
      // The journey underground showed her the light — the ghost is free.
      integration: {
        start: 0.871,
        end: 1.0,
        bloomIntensity: 0.7,
        ...
        aiPrompt: "photorealistic warm golden radiance flooding vast cosmic space from the upper-right — deep indigo-black receding to the far edges as amber-gold light fills the upper portion like sunrise through the cosmos itself, volumetric golden rays streaming diagonally, in the upper-right portion a tall statuesque luminous feminine angelic being levitating in golden radiance seen ONLY from behind — absolutely NO face visible NEVER even in profile, only dark silhouette against golden light, draped in an impossibly long flowing ethereal gown that cascades behind and below her dissolving into thousands of warm golden particles and luminous wisps, large semi-transparent wings fully spread behind her like veils of luminous golden gossamer — the wings dissolving at the edges into golden particles and light, the figure not filling the frame but anchored in the right third with generous dark void on the left, impossibly exaggerated hair in divine Leonardo da Vinci geometrical fibonacci spiraling curls interlaced with threads of pure gold light — the hair overwhelmingly alive flowing in massive spiraling cascades trailing behind and downward filling the space with Alphonse Mucha-style Art Nouveau flowing organic curves, individual hair strands becoming luminous particle threads that spiral outward in fibonacci patterns dissolving into constellations at the tips, luminous wisps and golden particle trails swirling everywhere through the cosmic space, the figure more hair and light and flowing gown than body, far below the faintest ghost of ancient roots descending into dark earth — the memory of the underground journey she emerged from, small isolated floating elements scattered in the dark void — a spiral of golden particles drifting alone, a wisp of luminous hair disconnected and floating like a jellyfish tendril, fragments of light, the smaller ghost figure far below in the lower-left still dark and translucent — grey wispy fibonacci spiral hair streaming upward connecting to the figure above, all figures emerging from particles and light not solid bodies — NEVER showing detailed facial features only silhouettes from behind, the hair IS the subject — divine spiraling cascading luminous particle hair filling space with organic mathematical beauty, NOT illustration style — photorealistic volumetric golden light and real material textures, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
