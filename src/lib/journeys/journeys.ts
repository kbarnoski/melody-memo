  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      expansion: {
        ...
        shaderOpacity: 0.65,
        aiPrompt: "photorealistic cinematic rear one-point perspective tracking shot, strong sense of forward motion. one white-haired angel woman hovering FORWARD deep into an endless underground tunnel lined with massive gnarled spiraling tree roots threading across walls and ceiling like a cathedral of living wood, her dress and hair streaming behind her in the draft of her movement, a distant pale bioluminescent teal arched stone portal visible small behind her receding into the distance marking where she came from. eyes closed peaceful expression, face hidden behind long fibonacci spiral white hair cascading past her waist, wearing a long flowing white dress flowing backward as she moves, two large transparent glowing white wings of pure light and mist extending behind her, dense swirling white particles streaming backward from her body, pale bioluminescent teal lichen glowing on the root bark, the tunnel stretching far ahead into deep indigo shadows. mysterious ethereal traveling passage, no text no watermarks",
        aiPromptModifiers: {
