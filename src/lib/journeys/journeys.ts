  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      threshold: {
        ...
        aiPrompt: "photorealistic ancient stone chamber bathed in pale silvery moonlight — tall arched window on the right opening onto infinite deep cosmic void with scattered distant stars, bright moonlight flooding through casting a luminous diagonal shaft across worn stone floors illuminating spectral particles like tiny stars, in the left portion a translucent dark feminine figure draped in flowing ethereal robes facing away toward the cosmic window — seen only from behind, the figure shifts subtly between diverse feminine forms as if a spirit able to change shape — three transparent overlapping layers of her arms in different positions from held close to fully outstretched each layer more transparent showing the gesture across time, the body itself with similar subtle transparent overlaps of slightly different builds and postures all merging into one presence — a spirit morphing between diverse beautiful angelic forms, beside her a translucent duplicate slowly pulling away — the soul separating, both figures with impossibly long dark hair in divine fibonacci spiraling curls drifting upward weightlessly trailing along the vaulted ceiling dissolving into fine luminous particle threads, dense spectral particles catching the moonlight throughout the chamber like dust motes in a cathedral, the figures ethereal and angelic — emerging from swirling particles not solid bodies, in the window glass a ghostly reflection that doesn't match anyone in the chamber, in the darkest corner above the suggestion of another translucent watcher, the mood deeply haunting but luminous — silvery moonlight on worn stone patina, no faces visible — only silhouettes from behind, no halos, generous cosmic void through the window, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // EMERGENCE: tunnel opens into vast cosmic space with floating tree.
      // Like finding light at the end of the passage — overwhelming scale shift.
      illumination: {
        start: 0.63,
        end: 0.78,
        shaderOpacity: 0.78,
        aiPrompt: "photorealistic surreal impossible landscape — emerging from dark underground stone into vast open cosmic space, a single massive ancient gnarled tree rooted in a floating island of dark earth in the upper-left third, its roots extending downward through open air into deep cosmic void below where they become luminous filaments connecting to distant star clusters, the tree's branches reaching upward into starfield above, the scale overwhelming after the claustrophobic tunnels, woven through the branches and roots a tall statuesque dark feminine angelic form draped in flowing ethereal fabric — turned away and partially hidden among the upper branches, no face visible, beside her a translucent spirit duplicate slowly separating and drifting outward into the cosmos — the soul departing, her grey wispy hair in divine Leonardo fibonacci spiraling curls streaming downward along the trunk and through every root becoming the luminous connections to the cosmos below, a second translucent tall dark feminine figure floats distant in the void — only trailing spiral hair and particles visible interweaving with the root-threads creating a shimmering network between earth and stars, a third barely-visible wisp of particles and hair far below, all figures ethereal — emerging from spectral particles not solid bodies, the mood haunting but opening — the underground darkness giving way to cosmic vastness, no halos, no detailed faces, fine particles dispersing from the hair intersections into the generous void, photorealistic bark texture on the tree, deep earth tones and spectral silver-blue, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPrompt: "warm golden radiance flooding vast cosmic space from the upper-right — deep indigo-black receding to the far edges as amber-gold light fills the upper two-thirds like sunrise through the cosmos itself, volumetric golden rays streaming diagonally, in the upper portion a tall statuesque luminous feminine angelic figure draped in flowing ethereal fabric in distant profile flying above and looking DOWN — her gaze directed toward a smaller darker feminine figure far below in the lower-left, as if watching over her from the heavens, no face visible — only the dark silhouette of the profile against golden light, very long grey wispy hair in divine Leonardo fibonacci spiraling curls interlaced with threads of pure gold light trailing behind and downward, the figure more light than body — no halo just radiance, from the waist down dissolving into thousands of warm golden particles descending gently toward the figure below, the smaller figure below still dark and translucent draped in ethereal fabric — the ghost of earlier phases — looking up with grey wispy fibonacci spiral hair streaming upward connecting to the figure above, behind both at infinite depth more wispy dark forms barely visible in the golden haze — the spirits of every phase now gathered, fine golden particles dispersing in all directions like pollen in cathedral sunlight, the contrast from the oppressive darkness of earlier phases to this warmth should feel overwhelming and earned, all figures ethereal — emerging from particles and light not solid bodies, no detailed faces on any figure, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
