...
// NO ocean — user directive: ocean overlay was covering the
// underground-pool narrative in phase 3.
const OVERLAY_STARS = "subtle translucent overlay of distant cosmic stars and faint fibonacci spiral particle streams bleeding through the scene like a dreamlike double-exposure";
const OVERLAY_HORIZON = "subtle translucent overlay of a distant infinite horizon line and faint fibonacci spiral particle streams bleeding through the scene";
const OVERLAY_SKY = "subtle translucent overlay of a pale distant sky and faint fibonacci spiral particle streams bleeding through the scene";
const OVERLAY_COSMOS = "subtle translucent overlay of deep cosmic nebulae and faint fibonacci spiral particle streams bleeding through the scene";
 ...
 *  No ocean — user removed it because it was covering the underground
 *  pool narrative during phase 3. Underground phases get root-network
 *  and horizon overlays; celestial phases get stars/sky/cosmos. */
  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      expansion: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 2 — portal into the earth, darkness pulling
          // her in, underground travel. Arms change position across beats.
          "photorealistic cinematic wide shot of a natural organic portal opening downward into the earth at the far end of a grand medieval stone castle chamber, the portal is made of intertwining ancient tree roots woven into a downward archway with pure white flowers (all-white centers, NO yellow) blooming along the root edges, a dark pulling void visible through the portal drawing inward, wisps of darkness reaching out of the portal. " + GHOST_ANGEL_WINGLESS + " small hovering toward the portal with her arms at her sides, back to the camera, long white spiral hair cascading to the floor and trailing in the air with white particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide shot of the interior of an organic earth portal, a descending passage of intertwining ancient tree roots with pure white flowers along the walls and a darkness pulling downward, deep shadows. " + GHOST_ANGEL_WINGLESS + " small and hovering downward into the passage with her back to the camera and her arms spread outward like a falling leaf, long white spiral hair flowing upward and around her in fibonacci curls, white particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic rear tracking wide shot deep into a vast natural deep-earth root passage, massive gnarled tree roots forming walls and a high vaulted ceiling far above, pale bioluminescent teal lichen glowing on the roots. " + GHOST_ANGEL_WINGLESS + " small and distant hovering forward in the middle of the vast passage with her back to the camera and her arms raised slightly, long white spiral fibonacci hair cascading to the ground and trailing in the air with white particles. mysterious ethereal underground, no text no watermarks",
          "photorealistic cinematic extreme wide shot of a colossal natural cathedral cavern deep in the earth, massive gnarled tree roots forming enormous soaring columns reaching a vaulted ceiling far overhead, pale bioluminescent teal glow on the bark, pure white flowers blooming across the floor. " + GHOST_ANGEL_WINGLESS + " tiny and very distant at the center of the vast space with her arms outstretched to either side like she is floating through water, face not visible due to scale, long white spiral hair trailing in the air. mysterious ethereal infinite underground, no text no watermarks",
          "photorealistic cinematic side-silhouette view of a small figure hovering past a junction in a natural deep-earth root passage, massive gnarled tree roots forming walls, bioluminescent teal glow, multiple root tunnels branching away into infinite darkness. " + GHOST_ANGEL_WINGLESS + " small in side silhouette with her arms trailing behind her as if moving through currents of air, long white spiral hair flowing in fibonacci curls behind, white particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low worm's-eye wide view looking up through a vast natural cavern ceiling hung with organic root stalactites dripping downward, pale bioluminescent teal lichen glowing on the roots. " + GHOST_ANGEL_WINGLESS + " small and hovering past overhead seen from below with her arms crossed over her chest in a peaceful floating pose, long white spiral hair cascading downward with white particles, face not visible from below. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic forward-looking wide shot from behind deep into a vast natural deep-earth root passage stretching far ahead into infinite darkness, massive gnarled tree roots forming walls and high vaulted ceiling. " + GHOST_ANGEL_WINGLESS + " small in the middle of the passage with her back to camera and her arms now reaching forward toward a distant point of pale teal light visible far ahead, long white spiral hair streaming with white particles. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      transcendence: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 3 — pool with DARK REFLECTION revealing a dark
          // angel looking back at her, black wings rise FROM the water,
          // merger with black wings, black dress. This is the possession
          // moment. Flash #1 fires during this phase.
          "photorealistic cinematic wide shot of a magnificent infinite natural cavern deep in the earth, a vast pool of still dark mirror-water stretching impossibly far covered in abundant pure white water lilies (all-white centers, NO yellow), high vaulted ceiling of gnarled tree roots far above, pale bioluminescent teal glow. " + GHOST_ANGEL_WINGLESS + " small hovering at the edge of the pool with her back to the camera, long white spiral hair cascading to the ground, arms at her sides. mysterious ethereal infinite pool, no text no watermarks",
          // Split-composition reflection — the critical reveal moment.
          // Made explicit so fal renders TWO distinct figures (above/below
          // water, one white, one black) instead of a single tinted image.
          "photorealistic cinematic split-composition vertical shot divided at the surface of a vast dark mirror-water pool covered in pure white water lilies inside a magnificent deep-earth cavern. TOP HALF OF FRAME: " + GHOST_ANGEL_WINGLESS + " small, white-haired, white-dressed, pale-skinned, hovering just above the water surface, long white spiral hair fanning around her, wings not yet present on her back. BOTTOM HALF OF FRAME (the reflection): the SAME angel figure but POSSESSED — jet black dress, translucent black wings around her, pale skin, same pose inverted — looking UP through the water at her white self above. the two figures are distinctly different colors. mysterious unsettling ethereal reflection reveal, no text no watermarks",
          "photorealistic cinematic horizontal split-composition shot at water level — the frame split left-right at the waterline into two mirrored halves of a vast dark pool covered in pure white water lilies. LEFT HALF (above water): " + GHOST_ANGEL_WINGLESS + " in profile hovering above the surface, white hair, white dress, pale, NO wings. RIGHT HALF (reflection below the surface): a DARK possessed mirror-version of her — jet black dress, translucent black wings visible behind her, same profile, looking at her white counterpart. the stark contrast of the white figure and her black reflected self is the image. magnificent deep-earth cavern backdrop, mysterious unsettling ethereal, no text no watermarks",
          "photorealistic cinematic wide shot of the surface of a vast dark mirror-water pool covered in pure white water lilies inside a magnificent cavern, a burst of dark energy rising from the water and a pair of TRANSLUCENT JET BLACK wispy wings (like flowing black smoke and shadow) rising up out of the water where the dark reflection was, black particles swirling, droplets of dark water scattering. " + GHOST_ANGEL_WINGLESS + " small hovering above with her body spread wide, arms raised as the black wings rise toward her, long white spiral hair blown back by the rising shadow force, white particles mixing with black. mysterious ethereal transformation moment, no text no watermarks",
          "photorealistic cinematic wide shot of the moment the translucent dark wispy wings merge and attach to a small figure's upper back at the shoulder blades above a vast dark mirror-water pool covered in pure white water lilies, a burst of dark particles exploding outward in fibonacci spiral patterns, magnificent deep-earth cavern around. " + GHOST_ANGEL + " small silhouetted against the dark burst, back to camera, long spiral hair rippling in the burst with spiraling particles. mysterious ethereal possession, no text no watermarks",
          "photorealistic cinematic extreme high overhead view looking straight down at a vast dark mirror-water pool covered in pure white lilies deep in a magnificent cavern, abundant fibonacci spiral particle patterns visible from above. " + GHOST_ANGEL + " small and newly transformed hovering horizontally above the water with body spread wide, long spiral hair fanning around her in fibonacci patterns, translucent wispy wings spread, face not visible from above. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide shot of " + GHOST_ANGEL + " tiny and distant flying through a vast epic underground cavern toward a distant warm amber-teal light at the far end, massive gnarled tree roots forming the colossal cavern, pale bioluminescent teal glow, long spiral hair streaming behind, translucent wispy wings spread, back to the camera, spiraling particle trails everywhere. mysterious ethereal cave flight, no text no watermarks",
          "photorealistic cinematic wide low-angle rear tracking shot of " + GHOST_ANGEL + " small flying through a magnificent deep-earth cavern toward a growing warm amber light glowing at the far exit, her back to the camera, translucent wispy wings spread, long spiral fibonacci hair cascading and trailing with abundant spiraling particles, white water lilies on the dark water below. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        aiPrompt:
          ...
          GHOST_ANGEL +
          " hovering forward through infinite cosmos toward a dark dead gnarled tree standing alone on a round spherical dark rocky planet ahead, the entire universe sky with stars nebulae and galaxies behind, her translucent butterfly-angel wings spread, her fibonacci spiral braids streaming with white particles, no text no watermarks",
        aiPromptSequence: [
          // Spec v3 §4 Phase 4 — she emerges out of the cave into cosmos,
          // sees tree on its own small planet with cosmos + sunset behind,
          // flies toward it. Flash #2 fires at arrival. The GHOST_ANGEL
          // marker substitutes the correct (possessed) variant automatically
          // based on flash count — no hardcoded wardrobe in the scene text.
          // Varied distance + POV per user directive: tiny / wide / low /
          // high / silhouette / three-quarter / overhead.
          "photorealistic cinematic extreme wide establishing shot of infinite cosmos, the dark mouth of a deep-earth root passage in the foreground opening out onto vast open universe sky of stars nebulae and spiral galaxies, a tiny small dark dead gnarled tree far in the distance on its own small spherical planet, a warm sunset-amber glow behind the tree. " + GHOST_ANGEL + " tiny and very distant emerging from the passage toward cosmos with her back to the camera, long spiral hair trailing with spiraling particles. cosmic scale mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme overhead high-angle shot looking down on the dark mouth of a deep-earth root passage from far above, infinite cosmos spreading outward, a small dark tree on its tiny spherical planet visible far off in the universe sky, warm sunset glow. " + GHOST_ANGEL + " tiny speck of a figure emerging from the passage below, long spiral hair trailing behind like a comet-tail, spiraling particles everywhere. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle worm's-eye wide shot looking up from below at an infinite cosmos above, a small dark dead tree on its tiny spherical planet high above in the universe sky of stars nebulae galaxies, sunset glow behind. " + GHOST_ANGEL + " small glowing figure flying upward from below toward the tree-planet, face not visible from this angle, long spiral hair cascading downward behind her with spiraling particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic silhouette side view of a small winged figure flying horizontally across a vast cosmic sunset, a small dark tree on its tiny spherical planet visible in the distance on the other side of the frame, universe sky of nebulae and galaxies. " + GHOST_ANGEL + " small and silhouetted against the sunset, face not visible in silhouette, long spiral hair trailing with spiraling particle trails. mysterious ethereal cosmic, no text no watermarks",
          "photorealistic cinematic three-quarter behind-the-shoulder wide view framing a small dark dead tree on its tiny spherical planet directly ahead in infinite cosmos, universe sky of stars nebulae galaxies and sunset glow as backdrop, spiraling particle streams connecting the angel to the tree. " + GHOST_ANGEL + " small in the foreground flying toward the tree-planet with her back to the camera, long spiral hair trailing, arms outstretched forward. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide approach shot of " + GHOST_ANGEL + " small approaching the small dark dead tree on its tiny spherical planet in cosmos, back to the camera, arms outstretched forward, the tree silhouetted against the vast warm sunset glow and the entire universe sky of stars nebulae galaxies, abundant spiral particle trails streaming behind her hair and wings. mysterious ethereal cosmic arrival, no text no watermarks",
          "photorealistic cinematic wide arrival shot of " + GHOST_ANGEL + " arriving very near the small dark dead tree on its tiny spherical planet, her form beginning to TRANSFORM — the translucent wings starting to flicker with white light breaking through their dark shadow, her dress beginning to brighten into white translucent mist, against the sunset glow and universe sky behind. back to camera, long spiral hair catching the transformation light, abundant spiraling particle trails. mysterious ethereal transformation moment, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPrompt:
          ...
          GHOST_ANGEL +
          "'s hand on the dark trunk of a gnarled tree with white flowers blooming outward across every branch from the point of her touch, the tree on its spherical planet in infinite cosmos, her translucent butterfly-angel wings spread, her fibonacci spiral braids streaming with white particles, no text no watermarks",
        aiPromptSequence: [
          // Spec v3 §4 Phase 5 — tree bloom progression made EXPLICIT with
          // hard percentages so fal anchors each stage distinctly. Stage
          // 1 = 0% (bare), Stage 2 = 5%, Stage 3 = 25%, Stage 4 = 50%,
          // Stage 5 = 75%, Stage 6 = 100% + merge. WHITE angel returned.
          // Seen from great distance throughout — no face.
          // Stage 1 — 0% bloom, tree entirely bare.
          "photorealistic cinematic extreme wide establishing shot of a small ancient gnarled tree standing alone on its own tiny spherical planet in vast infinite cosmos, the tree is ENTIRELY BARE with ZERO FLOWERS (0% bloom, 100% dead and empty branches), dark dead twisting branches reaching outward, warm sunset glow behind rimming the dead silhouette, universe sky of stars nebulae and spiral galaxies. " + GHOST_ANGEL + " small at the trunk with her back to the camera, long spiral hair cascading. mysterious ethereal arrival before any flowers bloom, no text no watermarks",
          // Stage 2 — 5% bloom, first few flowers.
          "photorealistic cinematic wide shot of a small gnarled tree on its tiny spherical planet in cosmos, ONLY about 5 PERCENT of the branches show the first tiny pure white flowers (just a single cluster of ~6 flowers at one small section), the OTHER 95% of the tree's branches are still completely bare and dead, warm sunset glow and universe sky behind. " + GHOST_ANGEL + " small at the tree base with her back to the camera, long spiral hair trailing. mysterious ethereal first-bloom moment, no text no watermarks",
          // Stage 3 — 25% bloom.
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet in cosmos, roughly 25 PERCENT of the branches now covered in scattered pure white flowers (all-white centers, NO yellow) with the remaining 75% of branches still bare and dark, a visible wave of bloom expanding outward from the center toward the tips. " + GHOST_ANGEL + " tiny at the trunk with back to camera. warm sunset glow, universe sky of stars nebulae galaxies. mysterious ethereal bloom spreading, no text no watermarks",
          // Stage 4 — 50% bloom.
          "photorealistic cinematic wide low-angle shot looking up at a small gnarled tree on its tiny spherical planet in cosmos, EXACTLY HALF the branches (50%) now covered in pure white flowers while the OTHER HALF (50%) are still bare and dark, the visible wave of bloom pushing outward from trunk toward branch tips, warm sunset glow behind. " + GHOST_ANGEL + " small silhouette at the base, long spiral hair trailing. mysterious ethereal half-bloom, no text no watermarks",
          // Stage 5 — 75% bloom.
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet in cosmos, roughly 75 PERCENT of the branches covered in dense pure white flowers with only the OUTERMOST 25% of branch tips still bare and dark, the tree nearly fully transformed, warm sunset glow rimming everything, universe sky of stars nebulae galaxies. " + GHOST_ANGEL + " tiny at the trunk. mysterious ethereal nearly full bloom, no text no watermarks",
          // Stage 6 — 100% bloom + merge begins.
          "photorealistic cinematic wide shot of a small gnarled tree on its tiny spherical planet in cosmos with EVERY BRANCH 100 PERCENT covered in pure white flowers (not a single bare twig remaining), the previously dead tree now fully alive in complete white bloom, warm golden-sunset light streaming through every branch in radiant shafts, universe sky behind. " + GHOST_ANGEL + " small at the trunk with back to camera, her body beginning to become translucent with the wood grain of the tree showing through her skin and dress, long spiral hair starting to blend into the blooming branches. mysterious ethereal full-bloom merging, no text no watermarks",
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet in infinite cosmos with every branch fully covered in pure white flowers, warm sunset glow and universe sky of stars nebulae galaxies behind. " + GHOST_ANGEL + " (white, peak adult form) fully merged into the blooming tree, only faint traces of her form visible in the wood grain, her long white spiral hair now flows as branches cascading through the blooming crown, her translucent wispy wings now are branch-shapes of light woven through the canopy. mysterious ethereal transcendent union, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 6 — cosmic zoom-out revealing the castle,
          // portal, and tree all in one infinite tableau, then soaring in
          // golden light. Transcendent but NOT religious.
          "photorealistic cinematic wide shot of a small blooming tree on its tiny planet covered in pure white flowers in infinite cosmos, warm sunset glow around, the camera beginning to zoom/pull back revealing more of the universe sky around the tree. " + GHOST_ANGEL + " (white, peak adult) merged and radiating from the tree, her form still faintly visible in the glowing blossoms. mysterious ethereal transcendent, no text no watermarks",
          "photorealistic cinematic extreme wide surreal cosmic zoom-out tableau — a collage of an entire journey visible in one infinite view: a grand medieval castle stone chamber with its tall arched window small in one part of the frame, a natural organic root portal with white flowers in another, a small blooming tree on its tiny planet in yet another, all floating in the same impossibly vast cosmic space, connected by a river of white and gold particles spiraling between them in fibonacci curves, universe sky of stars nebulae and spiral galaxies as backdrop. " + GHOST_ANGEL + " small and radiant rising out of the blooming tree toward golden light above, long white spiral hair trailing. mysterious ethereal surreal infinite tableau, no text no watermarks",
          "photorealistic cinematic extreme wide dreamlike collage shot of the whole Ghost story in one frame — grand castle chamber at one edge, a root-portal descending into dark earth in another, a bloomed white-flower tree on its tiny planet in another, with infinite golden cosmos pouring in from above, rivers of white and gold fibonacci particle-streams connecting all three scenes. " + GHOST_ANGEL + " (peak adult, radiant) small soaring upward out of the bloomed tree through the connecting golden particle river toward open golden cosmos, back to camera. mysterious ethereal transcendent surreal, no text no watermarks",
          "photorealistic cinematic low-angle wide shot looking up at infinite golden cosmos above pierced by volumetric amber sunrays, warm light streaming, the whole collage tableau receding below. " + GHOST_ANGEL + " (peak adult) seen from below ascending with both arms outstretched upward and head tilted back (face not visible from this angle), translucent wispy wings of light fully spread above her trailing dense golden particles, long white spiral fibonacci hair cascading down behind her with white and gold particles. mysterious ethereal transcendent flight, no text no watermarks",
          "photorealistic cinematic three-quarter back tracking wide shot across infinite golden cosmos pierced by volumetric amber sunrays, deep indigo deep-space backdrop, distant stars and galaxies. " + GHOST_ANGEL + " (peak adult) soaring horizontally through the golden light with her back to the camera, body angled upward with arms outstretched, translucent wispy wings spread trailing dense golden particle streams, long white spiral hair streaming back with white and gold particles, face turned away. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide silhouette shot of a vast golden-nebula cosmos filled with stars and distant spiral galaxies, volumetric amber sunrays everywhere across infinite scale. " + GHOST_ANGEL + " (peak adult) tiny and radiant silhouette soaring across the cosmos, translucent wispy wings spread trailing golden particles, long white spiral hair streaming far behind, face not visible in silhouette. mysterious ethereal cosmic freedom transcendent (NOT religious — cosmic and spiritual), no text no watermarks",
          "photorealistic cinematic wide rear shot of " + GHOST_ANGEL + " (peak adult) soaring further and deeper into infinite golden cosmos, translucent wispy wings spread trailing streams of golden particles, her very long white spiral fibonacci hair trailing far behind her like ribbons of light with white and gold particles spiraling along every strand, deep indigo cosmos pierced by volumetric amber sunrays, distant stars nebulae galaxies. mysterious ethereal freedom transcendent cosmic — NOT religious, no text no watermarks",
        ],
        aiPromptModifiers: {
