  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      threshold: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic extreme wide establishing shot, " + GHOST_ANGEL_WINGLESS + " tiny and alone standing in the distance by a tall arched stone window inside a vast dark ancient stone chamber, cosmic void with scattered stars visible beyond the window, moonlight streaming in across a worn stone floor cracked with ancient tree roots, her long fibonacci spiral braided hair catching moonlight with white particles spiraling along the braids, deep shadows fill most of the frame, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle shot looking steeply up, " + GHOST_ANGEL_WINGLESS + " framed by a tall arched stone window, moonlit cosmic void with stars visible through the window behind her, silver light rimming her silhouette, her fibonacci spiral braids cascading forward past her shoulders streaming with white particles, ancient dark chamber, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic side profile silhouette of " + GHOST_ANGEL_WINGLESS + " standing by the tall arched window, her profile outlined in silver moonlight against the cosmic void beyond, her long fibonacci spiral braided hair cascading down her back with white particles spiraling, dark stone chamber behind, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic three-quarter back view of " + GHOST_ANGEL_WINGLESS + " looking out at the cosmic void through a tall arched stone window, ancient stone chamber, diagonal moonlight shaft across the worn stone floor cracked with tree roots, her fibonacci spiral braids streaming down her back with white particles, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic close-up of " + GHOST_ANGEL_WINGLESS + "'s hand resting on the worn stone windowsill, ancient tree roots visible cracking through the stone around her hand, soft moonlight, one strand of her fibonacci spiral braid draped across her wrist with white particles spiraling along it, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic overhead top-down shot of " + GHOST_ANGEL_WINGLESS + " standing alone on a worn stone floor cracked with ancient tree roots, a shaft of silver moonlight illuminating her from the arched window above, her fibonacci spiral braided hair spreading out around her with white particles, mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      expansion: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic wide shot of " + GHOST_ANGEL_WINGLESS + " hovering through an organic living archway of intertwining tree roots, warm golden light glowing behind her from the chamber she just left, entering a vast natural underground passage ahead, massive gnarled tree roots forming the walls, pale bioluminescent teal glow, her fibonacci spiral braided hair streaming behind her with white particles, mysterious ethereal traveling, no text no watermarks",
          "photorealistic cinematic rear one-point tracking shot, " + GHOST_ANGEL_WINGLESS + " hovering forward through a vast natural deep-earth root passage, massive gnarled tree roots forming the walls and high vaulted ceiling far above her head, pale bioluminescent teal lichen glowing on the bark, her fibonacci spiral braids streaming behind her with white particles, dress flowing back in the draft of her motion, mysterious ethereal traveling, no text no watermarks",
          "photorealistic cinematic extreme wide shot, " + GHOST_ANGEL_WINGLESS + " tiny and glowing at the center of a colossal natural underground cathedral cavern of gnarled tree roots forming soaring columns, pale bioluminescent teal glow, her fibonacci spiral braided hair catching light with white particles spiraling, mysterious ethereal infinite underground, no text no watermarks",
          "photorealistic cinematic side view of " + GHOST_ANGEL_WINGLESS + " hovering past a junction in a deep-earth passage where multiple organic root tunnels branch away into infinite darkness, massive gnarled roots forming walls and ceiling, bioluminescent teal glow, her fibonacci spiral braids streaming with white particles, mysterious ethereal traveling, no text no watermarks",
          "photorealistic cinematic low-angle worm's-eye view looking up as " + GHOST_ANGEL_WINGLESS + " hovers past overhead, organic root stalactites dripping from the ceiling of a vast natural cavern, bioluminescent teal lichen glowing on the roots, her fibonacci spiral braided hair streaming with white particles visible from below, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic macro close-up of pure white flowers with all-white petals and all-white centers (NO yellow) springing up from the earth floor in the wake of " + GHOST_ANGEL_WINGLESS + " moving forward in the background, deep-earth passage, bioluminescent teal glow on the nearby roots, her fibonacci braids visible streaming with white particles, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic forward-looking shot from behind " + GHOST_ANGEL_WINGLESS + " deep into a natural tree-root passage stretching far ahead into infinite darkness with a distant warm golden pinpoint of light visible at the very far end, her fibonacci spiral braids streaming behind her with white particles, mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      transcendence: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic wide shot of " + GHOST_ANGEL_WINGLESS + " hovering just above the edge of a vast infinite pool of still dark mirror-water covered in abundant pure white water lilies (all-white petals, all-white centers, NO yellow), deep in a natural open cavern with a high vaulted ceiling of gnarled tree roots, pale bioluminescent teal glow on the roots, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic mid-distance shot of " + GHOST_ANGEL_WINGLESS + " looking down into the water at a pair of glowing translucent white butterfly-angel wings floating on the surface between the white water lilies, soft white light emanating from the wings, her fibonacci spiral braids reaching down as she leans over, white particles spiraling around her, deep-earth cavern, no text no watermarks",
          "photorealistic cinematic close-up of " + GHOST_ANGEL_WINGLESS + "'s hands lifting a pair of glowing translucent iridescent white butterfly-angel wings up out of the dark mirror-water, droplets falling from the shimmering membrane wings, soft halo of white light around the wings, her fibonacci spiral braided hair cascading forward with white particles, no text no watermarks",
          "photorealistic cinematic mid-shot of the exact moment the translucent butterfly-angel wings attach anatomically to " + GHOST_ANGEL_WINGLESS + "'s upper back at her shoulder blades, a burst of pure white light and swirling white particles exploding outward around her at the moment of attachment, her fibonacci spiral braids rippling in the burst, deep-earth cavern, no text no watermarks",
          "photorealistic cinematic overhead top-down view of " + GHOST_ANGEL + " hovering horizontally just above the infinite lily pool with her body spread wide like a star, her PERFECT REFLECTION clearly visible in the mirror-water beneath her matching her pose, abundant pure white water lilies scattering around her, her new translucent iridescent butterfly-angel wings fully spread on her back, her fibonacci spiral braids spreading across the water surface with white particles, no text no watermarks",
          "photorealistic cinematic low-angle shot from water level looking up past the white water lilies at " + GHOST_ANGEL + " hovering above the pool, her translucent butterfly-angel wings spread on her back, her fibonacci spiral braids streaming with white particles cascading down, pale bioluminescent teal glow on the cavern roots, no text no watermarks",
          "photorealistic cinematic three-quarter view of " + GHOST_ANGEL + " hovering above the infinite pool with wings spread, turning to face a distant warm golden light glowing at the far end of the natural cavern passage ahead, white water lilies on the dark water around her, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic rear tracking shot of " + GHOST_ANGEL + " hovering forward across the infinite pool of white water lilies toward a distant warm golden light glowing at the far end of the natural cavern passage, lilies rippling in her wake, her translucent butterfly-angel wings spread on her back, her fibonacci spiral braids streaming with white particles, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic wide shot of " + GHOST_ANGEL + " emerging from the dark mouth of a deep-earth root passage out into vast open infinite cosmos, the entire universe sky of stars nebulae and galaxies suddenly surrounding her, a distant dark dead tree visible on a small round spherical planet far ahead, her translucent butterfly-angel wings spread on her back, her fibonacci spiral braids streaming behind with white particles, no text no watermarks",
          "photorealistic cinematic extreme wide establishing shot of " + GHOST_ANGEL + " tiny and flying through infinite cosmos toward a dark dead gnarled tree standing on its own perfectly round spherical dark rocky planet ahead, entire universe sky filled with stars nebulae and spiral galaxies as backdrop, her translucent butterfly-angel wings on her back, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic mid-distance shot of " + GHOST_ANGEL + " flying forward through cosmos with her body angled forward arms slightly raised, the dark dead tree on its spherical planet clearly visible ahead growing larger, distant warm golden cosmic dawn glow rimming the dark dead branches, her translucent butterfly-angel wings spread, her fibonacci spiral braids and dress streaming back with white particles, no text no watermarks",
          "photorealistic cinematic low-angle looking up at the silhouette of the dark dead gnarled tree on its round spherical planet against the cosmos sky, " + GHOST_ANGEL + " flying toward it visible as a small glowing figure approaching from below, her translucent butterfly-angel wings spread, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic three-quarter view behind " + GHOST_ANGEL + " framing the dark dead tree-planet directly ahead growing large in the cosmos, the entire universe sky of stars nebulae galaxies behind the tree, distant warm golden cosmic dawn, her translucent butterfly-angel wings spread, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic close shot of " + GHOST_ANGEL + " in flight, the dark dead gnarled tree filling most of the background on its spherical planet, her body angled forward with arms slightly raised, her translucent butterfly-angel wings spread on her back, her fibonacci spiral braids streaming forward past her shoulders with white particles spiraling, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic close-up of " + GHOST_ANGEL + "'s hand resting on the dark lifeless bark of the ancient gnarled tree trunk, only the first 2 or 3 tiny pure white flowers (all-white petals, all-white centers, NO yellow) emerging from the bark right at her fingertips, the rest of the branches completely bare and dead, warm golden dawn glow behind, her translucent butterfly-angel wings visible, her fibonacci spiral braids with white particles, no text no watermarks",
          "photorealistic cinematic mid-shot of " + GHOST_ANGEL + " standing at the base of the ancient tree with her hand on the trunk, a cluster of ~20 pure white flowers (all-white petals, all-white centers, NO yellow) opened in a halo around her hand, every other branch of the tree still bare and dead, the spherical planet beneath her, cosmos behind, her translucent butterfly-angel wings spread, her fibonacci spiral braids streaming with white particles, no text no watermarks",
          "photorealistic cinematic mid-distance shot of the ancient gnarled tree on its spherical planet with roughly half the branches partially bloomed with pure white flowers (all-white petals, all-white centers, NO yellow) and half still bare and dead, a visible wave of bloom expanding outward across the branches, " + GHOST_ANGEL + " small with her hand on the trunk, cosmos behind, her translucent butterfly-angel wings spread, her fibonacci spiral braids with white particles, no text no watermarks",
          "photorealistic cinematic wide shot of the ancient gnarled tree on its spherical planet with every branch completely covered in pure white flowers (all-white petals, all-white centers, NO yellow), the previously dead tree now fully alive in white bloom, warm golden light streaming through the branches, " + GHOST_ANGEL + " small at the trunk, cosmos behind, her translucent butterfly-angel wings spread, her fibonacci spiral braids with white particles, no text no watermarks",
          "photorealistic cinematic front view of " + GHOST_ANGEL + " with her body beginning to become translucent, wood grain of the tree trunk visible through her skin and dress, every branch of the tree around her in full pure white bloom, warm golden light streaming through her translucent body in radiant shafts, her fibonacci spiral braids starting to blend into the branches, her translucent butterfly-angel wings starting to become branch-shapes of light, no text no watermarks",
          "photorealistic cinematic wide shot of " + GHOST_ANGEL + " fully merged into the ancient gnarled tree on its spherical planet, her body dissolved into the trunk and limbs with only faint traces of her form visible in the wood grain, her fibonacci spiral braids now are branches, her butterfly-angel wings now are branch-shapes of light, every branch in full pure white bloom, cosmos of stars nebulae galaxies behind, warm golden cosmic dawn, ethereal transcendent union, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPromptSequence: [
          "photorealistic cinematic wide shot of " + GHOST_ANGEL + " rising upward from the blooming tree-planet now far below her, her translucent butterfly-angel wings spread trailing golden particles, her fibonacci spiral braids streaming behind with white particles, deep indigo cosmos pierced by volumetric warm golden sunrays, distant stars nebulae galaxies, ethereal release, no text no watermarks",
          "photorealistic cinematic low-angle looking up at " + GHOST_ANGEL + " ascending with both arms outstretched upward and head tilted back, her translucent butterfly-angel wings fully spread above her trailing dense golden particles, her fibonacci spiral braids streaming with white and gold particles, warm golden cosmos above, ethereal transcendent flight, no text no watermarks",
          "photorealistic cinematic three-quarter tracking shot of " + GHOST_ANGEL + " soaring horizontally through infinite golden cosmos, body angled upward with arms outstretched, her translucent butterfly-angel wings spread trailing dense golden particle streams, her fibonacci spiral braids streaming back with white and gold particles, volumetric amber sunrays piercing through the cosmos, ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide silhouette of " + GHOST_ANGEL + " tiny and radiant, soaring across a vast golden-nebula cosmos filled with stars and distant spiral galaxies, volumetric amber sunrays everywhere, her translucent butterfly-angel wings spread trailing golden particles, ethereal cosmic freedom, no text no watermarks",
          "photorealistic cinematic close three-quarter of " + GHOST_ANGEL + "'s face with eyes closed in ecstatic peaceful expression, head tilted back, warm golden light washing across her features, her fibonacci spiral braids streaming back with white and gold particles, translucent butterfly-angel wings visible spread at her back, golden cosmos around her, ethereal transcendent, no text no watermarks",
          "photorealistic cinematic wide finale shot of " + GHOST_ANGEL + " soaring forward into infinite golden cosmos with arms outstretched upward, head tilted back, body angled upward rising into infinity, her translucent butterfly-angel wings fully spread trailing dense golden particle streams, her fibonacci spiral braids streaming far back with white and gold particles, deep indigo cosmos pierced by volumetric amber sunrays, distant stars nebulae galaxies, ethereal freedom nirvana, no text no watermarks",
        ],
        aiPromptModifiers: {
