  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      expansion: {
        ...
        shaderOpacity: 0.65,
        aiPrompt: "photorealistic cinematic rear tracking shot. ancient stone chamber wall opening into a tall arched stone portal glowing with pale bioluminescent teal light. beyond the portal, an endless underground tunnel lined with massive gnarled spiraling tree roots threading across walls and ceiling like a cathedral of living wood. one white-haired angel woman hovering through the portal into the root tunnel, eyes closed peaceful expression, arms trailing, face hidden behind long fibonacci spiral white hair cascading past her waist, wearing a long flowing white dress, two large transparent glowing white wings of pure light and mist extending behind her, dense swirling white particles trailing from her body, pale bioluminescent teal lichen glowing on the root bark, deep indigo shadows beyond. mysterious ethereal passage, no text no watermarks",
        aiPromptModifiers: {
