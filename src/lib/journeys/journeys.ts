  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      threshold: {
        ...
        aiPromptSequence: [
          // Spec v1 Section 4 Phase 1 — all wide/mid/distant, no close-ups,
          // angel tiny within the vast space, face always obscured.
          "photorealistic cinematic extreme wide establishing shot of a vast ancient dark stone chamber at night, a tall arched stone window far ahead opening onto cosmic void scattered with faint stars, a diagonal shaft of silver moonlight cutting across a worn stone floor cracked with ancient tree roots, deep shadows filling most of the frame. " + GHOST_ANGEL_WINGLESS + " tiny and distant standing alone by the window, face turned toward the window and obscured by her long spiral hair. mysterious ethereal space, no text no watermarks",
          "photorealistic cinematic low-angle wide shot looking steeply up at a tall arched stone window that fills most of the frame, cosmic void with stars visible through the window, silver moonlight rimming the stone archway, deep shadows in the dark ancient stone chamber below. " + GHOST_ANGEL_WINGLESS + " a small silhouetted figure at the base of the window, face not visible. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic side profile silhouette view across a dark ancient stone chamber at night, diagonal shaft of silver moonlight streaming through a tall arched window, ancient stone walls, deep shadows. " + GHOST_ANGEL_WINGLESS + " a small profile silhouette standing by the window, her long spiral fibonacci hair cascading to the floor and trailing in the air catching moonlight with white particles, face hidden in profile silhouette. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic overhead top-down wide view of a vast ancient stone chamber with worn stone floor cracked by ancient tree roots, a shaft of silver moonlight cutting across the floor from a tall arched window, deep shadows in the corners. " + GHOST_ANGEL_WINGLESS + " a small figure alone on the stone floor seen from above, her long spiral hair cascading around her on the floor in a fibonacci pattern with white particles, face not visible from above. mysterious ethereal space, no text no watermarks",
          "photorealistic cinematic three-quarter back view from across a vast ancient stone chamber looking toward a tall arched stone window at the far end opening onto cosmic void, diagonal moonlight shaft across the stone floor cracked with tree roots between the viewer and the window, deep shadows. " + GHOST_ANGEL_WINGLESS + " standing small in the distance by the window with her back to the camera, long spiral fibonacci hair cascading down her back to the ground. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic distant shot through an interior stone archway of a vast ancient chamber, looking through into another dim moonlit stone room beyond, ancient tree roots in the floor, deep shadows. " + GHOST_ANGEL_WINGLESS + " small in the distant room seen through the archway, her long spiral hair trailing, face turned away. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      expansion: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 2 — scene-first, seven beats.
          "photorealistic cinematic wide shot of a natural organic living portal made of intertwining ancient tree roots woven into an archway, pure white flowers with all-white centers blooming along the root edges, warm golden pulling light glowing behind the archway, a vast natural underground passage opening beyond. " + GHOST_ANGEL_WINGLESS + " small hovering through the portal. no man-made stone, mysterious ethereal, no text no watermarks",
          "photorealistic cinematic rear tracking wide shot deep into a vast natural deep-earth root passage, massive gnarled tree roots forming walls and a high vaulted ceiling far above, pale bioluminescent teal lichen glowing on the roots. " + GHOST_ANGEL_WINGLESS + " small hovering forward in the middle of the vast passage, braids streaming with white particles. no man-made tunnel, mysterious ethereal underground, no text no watermarks",
          "photorealistic cinematic extreme wide shot of a colossal natural cathedral cavern deep in the earth, massive gnarled tree roots forming enormous soaring columns reaching a vaulted ceiling far overhead, pale bioluminescent teal glow on the bark. " + GHOST_ANGEL_WINGLESS + " tiny and glowing at the center of the vast space. mysterious ethereal infinite underground, no text no watermarks",
          "photorealistic cinematic side view of a junction in a natural deep-earth root passage where multiple organic root tunnels branch away into infinite darkness in every direction, massive gnarled roots forming walls, bioluminescent teal glow. " + GHOST_ANGEL_WINGLESS + " small and hovering past one of the branches. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low worm's-eye view looking up through a vast natural cavern ceiling hung with organic root stalactites dripping downward, pale bioluminescent teal lichen glowing on the roots. " + GHOST_ANGEL_WINGLESS + " small and hovering past overhead, braids streaming with white particles. mysterious ethereal, no text no watermarks",
          // Close-up pivot (1 of 7): flowers springing in her wake.
          "photorealistic cinematic close-up pivot shot of pure white flowers with all-white petals and all-white centers (NO yellow, NO color) springing from the earth floor of a natural deep-earth passage, massive tree roots visible around, pale bioluminescent teal glow. " + GHOST_ANGEL_WINGLESS + " small and distant in the background moving away. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic forward-looking wide shot deep into a vast natural deep-earth root passage stretching far ahead into infinite darkness with a distant warm golden pinpoint of light visible at the very far end, massive gnarled tree roots forming walls and high vaulted ceiling. " + GHOST_ANGEL_WINGLESS + " small in the middle of the passage, braids streaming with white particles. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      transcendence: {
        ...
        aiPromptSequence: [
          // Spec v1 Section 4 Phase 3 — wings-find story, all wide/mid, no close-ups.
          "photorealistic cinematic wide shot of a magnificent natural cavern deep underground where a vast infinite pool of still dark mirror-water fills the floor and stretches impossibly far in every direction, covered in abundant pure white water lilies (all-white petals, all-white centers, NO yellow), a high vaulted ceiling of gnarled tree roots far above, pale bioluminescent teal glow on the roots. " + GHOST_ANGEL_WINGLESS + " small hovering at the edge of the pool seeing it for the first time, her back toward the camera, long spiral hair cascading down. mysterious ethereal infinite pool, no text no watermarks",
          "photorealistic cinematic mid-wide shot of a vast pool of dark mirror-water covered in pure white water lilies (all-white centers, NO yellow), a pair of translucent flowing wispy angel wings made of pure light and mist floating on the water's surface between the lilies with a soft halo of white light around them, inside a magnificent deep-earth cavern with gnarled tree roots. " + GHOST_ANGEL_WINGLESS + " small and leaning down looking at the wings from behind the camera's view, face obscured by her long spiral hair. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic mid-wide shot of dark mirror-water covered in pure white water lilies inside a magnificent natural cavern, a pair of translucent flowing wispy angel wings of light and mist being lifted up out of the water (droplets falling from the wisps), halo of white light around the wings. " + GHOST_ANGEL_WINGLESS + " small in the middle of the scene lifting the wings with both hands, her back to the camera, long spiral hair cascading forward. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide shot of the wings-attaching moment inside a magnificent deep-earth cavern above a vast pool of dark mirror-water with pure white lilies, a burst of pure white light and swirling white particles exploding outward from a small figure at the center. " + GHOST_ANGEL_WINGLESS + " small silhouetted against the burst, back to camera, long spiral hair rippling in the light-burst. mysterious ethereal transformation, no text no watermarks",
          "photorealistic cinematic extreme high overhead shot looking straight down at the vast pool of dark mirror-water covered in pure white water lilies inside a magnificent deep-earth cavern. " + GHOST_ANGEL + " small and newly winged hovering horizontally above the water with body spread wide, her PERFECT REFLECTION clearly visible in the mirror-water directly below matching her pose, long spiral hair fanning out, translucent wispy wings of light spread, face not visible from above. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide low-angle shot from water level looking up past pure white water lilies into a magnificent deep-earth cavern with gnarled root ceiling far above, pale bioluminescent teal glow. " + GHOST_ANGEL + " small hovering above the pool in the middle distance, translucent wispy wings of light spread on her back, long spiral hair trailing, face not visible from below. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide three-quarter back view of a vast pool of dark mirror-water covered in pure white water lilies, a distant warm golden light glowing at the far end of the natural cavern passage ahead. " + GHOST_ANGEL + " small hovering above the pool with wings spread and back to the camera, long spiral hair trailing, turning to face the distant light. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic rear tracking wide shot of a vast infinite pool of dark mirror-water covered in pure white water lilies stretching ahead to a distant warm golden light glowing at the far end of the natural cavern passage. " + GHOST_ANGEL + " small hovering forward across the pool toward the light with her back to the camera, wings spread, long spiral hair trailing, lilies rippling in her wake. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        aiPromptSequence: [
          // Spec v1 Section 4 Phase 4 — all wide/distant, no close-ups.
          "photorealistic cinematic wide shot of the dark mouth of a deep-earth root passage opening out onto vast open infinite cosmos, the entire universe sky of stars nebulae and spiral galaxies visible ahead, a distant dark dead gnarled tree on its own small round spherical dark rocky planet far ahead. " + GHOST_ANGEL + " small emerging from the passage into cosmos with her back to the camera, long spiral hair trailing. mysterious ethereal cosmic dawn, no text no watermarks",
          "photorealistic cinematic extreme wide establishing shot of infinite cosmos with a dark dead gnarled tree standing alone on its own perfectly round spherical dark rocky planet (a complete planet, not a chunk, not a crystal island, not a fragment), the entire universe sky filled with countless stars vast colorful nebulae and distant spiral galaxies as backdrop. " + GHOST_ANGEL + " tiny and distant flying through cosmos toward the tree-planet, face not visible due to scale. mysterious ethereal cosmic scale, no text no watermarks",
          "photorealistic cinematic mid-distance back view of a dark dead gnarled tree standing on its round spherical planet hovering in infinite cosmos, distant warm golden cosmic dawn glow behind rimming the dead branches with faint amber, universe sky of stars nebulae galaxies as backdrop. " + GHOST_ANGEL + " small flying forward with her back to the camera, body angled forward arms slightly raised, long spiral hair and dress streaming back with particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle wide shot looking up at the dark gnarled silhouette of a dead tree on its round spherical planet against an infinite cosmos of stars nebulae and spiral galaxies, distant warm golden cosmic dawn glow behind. " + GHOST_ANGEL + " small glowing silhouette flying up from below toward the tree, face not visible. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic three-quarter behind-the-shoulder wide view framing a dark dead tree on its round spherical planet growing large directly ahead in infinite cosmos, universe sky of stars nebulae galaxies filling the backdrop, distant warm golden cosmic dawn. " + GHOST_ANGEL + " small in the foreground flying toward the tree with her back to the camera, long spiral hair trailing. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide silhouette shot of a dark dead tree on its round spherical planet and a small winged angel figure both silhouetted against a vast distant cosmic sunrise glow in infinite cosmos filled with stars nebulae and galaxies. " + GHOST_ANGEL + " small silhouette still flying toward the tree, face not visible in silhouette. mysterious ethereal cosmic scale, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPromptSequence: [
          // Spec v1 Section 4 Phase 5 — bloom progression. First phase where
          // closer shots are allowed; close shots are on the TRUNK / HAND /
          // FLOWERS, never her face.
          // Stage 1 — close pivot on dead trunk + first 2-3 tiny flowers.
          "photorealistic cinematic close shot of dark lifeless gnarled tree bark on a spherical planet in cosmos, a hand pressed against the trunk, only the first 2 or 3 tiny pure white flowers (all-white petals, all-white centers, NO yellow) emerging from the bark right at the fingertips, the rest of the visible branches completely bare and dead, warm golden cosmic dawn glow behind, universe sky. no face visible in the shot — only trunk, hand, and emerging flowers. mysterious ethereal, no text no watermarks",
          // Stage 2 — mid shot, halo of ~20 flowers around her hand.
          "photorealistic cinematic mid shot at the base of a dark dead gnarled tree on its spherical planet with a cluster of ~20 pure white flowers (all-white petals, all-white centers, NO yellow) opened in a halo around a hand pressed on the trunk, every other branch of the tree still bare and dead, the spherical planet below, cosmos of stars nebulae galaxies as backdrop. " + GHOST_ANGEL + " small at the trunk with her back to the camera, long spiral hair cascading to the ground around her, face not visible. mysterious ethereal, no text no watermarks",
          // Stage 3 — mid-wide, half blooming half bare.
          "photorealistic cinematic mid-wide back view of an ancient gnarled tree on its spherical planet with roughly half the branches partially bloomed with pure white flowers (all-white centers, NO yellow) and half still bare and dead, a visible wave of bloom expanding outward across the branches, cosmos of stars nebulae galaxies behind. " + GHOST_ANGEL + " small with her back to the camera and her hand on the trunk, long spiral hair cascading down. mysterious ethereal, no text no watermarks",
          // Stage 4 — wide full bloom.
          "photorealistic cinematic wide shot of an ancient gnarled tree on its round spherical planet with every branch now completely covered in pure white flowers (all-white petals, all-white centers, NO yellow), the previously dead tree now fully alive in white bloom, warm golden light streaming through the branches, universe sky of stars nebulae galaxies backdrop. " + GHOST_ANGEL + " small and silhouetted at the trunk with her back to the camera. mysterious ethereal, no text no watermarks",
          // Stage 5 — merge begins, translucent body.
          "photorealistic cinematic wide back-three-quarter view of an ancient gnarled tree fully covered in pure white flowers (all-white centers, NO yellow) on its spherical planet in cosmos, warm golden light streaming through every branch in radiant shafts. " + GHOST_ANGEL + " with her back to the camera, body beginning to become translucent and wood grain showing through her skin and dress, long spiral fibonacci hair starting to blend into the branches of the tree, translucent wispy wings starting to become branch-shapes of light, face not visible. mysterious ethereal transcendent union, no text no watermarks",
          // Stage 6 — merge complete.
          "photorealistic cinematic wide shot of an ancient gnarled tree on its round spherical planet in infinite cosmos with every branch fully covered in pure white flowers, warm golden cosmic dawn behind, universe sky of stars nebulae galaxies. " + GHOST_ANGEL + " fully merged into the tree with only faint traces of her body visible in the wood grain, her long spiral fibonacci hair now are branches cascading through the blooming crown and her translucent wispy wings now are branch-shapes of light. mysterious ethereal transcendent union, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPromptSequence: [
          // Spec v1 Section 4 Phase 6 — all wide/distant, no face shots.
          "photorealistic cinematic wide shot of a blooming tree-planet covered in pure white flowers seen far below, golden cosmos ahead filled with volumetric amber sunrays, deep indigo cosmos pierced by light, distant stars nebulae galaxies. " + GHOST_ANGEL + " small rising upward from the planet with her back to the camera, translucent wispy wings of light spread trailing golden particles, long spiral hair streaming back. mysterious ethereal release, no text no watermarks",
          "photorealistic cinematic low-angle wide shot looking up at infinite golden cosmos above pierced by volumetric amber sunrays, warm light streaming. " + GHOST_ANGEL + " seen from below ascending with both arms outstretched upward and head tilted back (face not visible from this angle), translucent wispy wings of light fully spread above her trailing dense golden particles, long spiral fibonacci hair cascading down behind her with white and gold particles. mysterious ethereal transcendent flight, no text no watermarks",
          "photorealistic cinematic three-quarter back tracking wide shot across infinite golden cosmos pierced by volumetric amber sunrays, deep indigo deep-space backdrop, distant stars and galaxies. " + GHOST_ANGEL + " soaring horizontally through the golden light with her back to the camera, body angled upward with arms outstretched, translucent wispy wings spread trailing dense golden particle streams, long spiral hair streaming back with white and gold particles, face turned away. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide silhouette shot of a vast golden-nebula cosmos filled with stars and distant spiral galaxies, volumetric amber sunrays everywhere across infinite scale. " + GHOST_ANGEL + " tiny and radiant silhouette soaring across the cosmos, translucent wispy wings spread trailing golden particles, long spiral hair streaming far behind, face not visible in silhouette. mysterious ethereal cosmic freedom, no text no watermarks",
          "photorealistic cinematic distant figure wide shot of deep indigo cosmos pierced by volumetric amber sunrays filled with stars nebulae and spiral galaxies. " + GHOST_ANGEL + " small flying through the golden light with back turned, translucent wispy wings spread trailing dense golden particles, long spiral hair trailing far behind. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide rear shot of " + GHOST_ANGEL + " soaring further and deeper into infinite golden cosmos, translucent wispy wings spread trailing streams of golden particles, her very long spiral fibonacci hair trailing far behind her like ribbons of light with white and gold particles spiraling along every strand, deep indigo cosmos pierced by volumetric amber sunrays, distant stars nebulae galaxies. mysterious ethereal freedom nirvana, no text no watermarks",
        ],
        aiPromptModifiers: {
